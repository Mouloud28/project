...
{
    #[Route('/', name: 'app_admin_metier_index', methods: ['GET'])]
    public function index(MetierRepository $metierRepository): Response
    {
        return $this->render('admin_metier/index.html.twig', [
            'metiers' => $metierRepository->findAll(),
        ]);
    }

    #[Route('/new', name: 'app_admin_metier_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_admin_metier_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('admin_metier/new.html.twig', [
            'metier' => $metier,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_admin_metier_show', methods: ['GET'])]
    public function show(Metier $metier): Response
    {
        return $this->render('admin_metier/show.html.twig', [
            'metier' => $metier,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_admin_metier_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Metier $metier, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin_metier/edit.html.twig', [
            'metier' => $metier,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_admin_metier_delete', methods: ['POST'])]
